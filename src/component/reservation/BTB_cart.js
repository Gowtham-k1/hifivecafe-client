...
import '../../css component/BTB_cart.css'
...
const BTB_cart = () => {
    ...
    useEffect(() => {
        axios.get(`${basaeurl}birthday/category/get?reser_cat_id=2&type=fc`)
            .then((res) => {
                let data = res?.data;
    ...
    useEffect(() => {
        axios.get(`${basaeurl}birthday/category/get?reser_cat_id=2&type=B`)
            .then((res) => {
                let data = res?.data;
    ...
    useEffect(() => {
        axios.get(`${basaeurl}birthday/category/get?reser_cat_id=2&type=PS`)
            .then((res) => {
                let data = res?.data;
    ...
    useEffect(() => {
        axios.get(`${basaeurl}birthday/category/get?reser_cat_id=2&type=PH`)
            .then((res) => {
                let data = res?.data;
                        ...
                        <div className='row BTB_cart_row2'>
                            ...
                            <div className='col-lg-6 BTB_cart_row2_1'>
                                ...
                                <div className='BTB_cart_row2_1_1'>
                                    <img src="https://i.pinimg.com/736x/b9/38/3a/b9383a4c1cf0820dd090a81468488c4b.jpg" alt="" />

                                </div>
                                <div className='BTB_cart_row2_1_2'>
                                    <img src="https://www.miraculousmemories.com/cdn/shop/files/373C5B9B-EB9B-48D4-BCB9-DB61E5914BC5.jpg?v=1698498020&width=1946" alt="" />
