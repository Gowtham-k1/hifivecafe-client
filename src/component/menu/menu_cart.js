...
import "../../css component/menu_cart.css"
...
const Menu_cart = () => {
    ...
    const handleIncrement = (user_id, main_id, main_sub_id, cart_type, denomination, cart_total, cart_id) => {
        ...
        axios.post(`${baseurl}add/to/cart/update/api`, { user_id: user_id, main_id: main_id, main_sub_id: main_sub_id, cart_type: cart_type, denomination: den, cart_total: tot, cart_id: cart_id })
            .then((res) => {
    ...
    useEffect(() => {
        axios.get(`${baseurl}cart/list/api?userid=${user_id}`)
            .then((res) => {
                if (res.data.Response.Success == 1) {
    ...
    const delete_func = (main_id, main_sub_id, cart_id) => {
        axios.post(`${baseurl}add/to/cart/remove/api`, { main_id: main_id, main_sub_id: main_sub_id, cart_id: cart_id })
            .then((res) => {
                console.log(res);
                if (res.data.Response.Success == 1) {
                    window.location.reload()
