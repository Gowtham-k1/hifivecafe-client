...
const Menu = () => {
    ...
    useEffect(() => {
        axios.get(`${baseurl}menu/category/get/list?menu_id=1`)
            .then((res) => {
    ...
    const menucat = (e) => {
        setMenu_id(e)
        axios.get(`${baseurl}menu/item/list?menu_cat_id=${e}`)
            .then((res) => {
                console.log(res);
                if (res.data.Response.Success == 1) {
    ...
    const menu_add = (user_id, menu_id, sub_menu_id, type, denomination, menu_price) => {
        ...
        axios.post(`${baseurl}add/to/cart/api`, { user_id: user_id, main_id: menu_id, main_sub_id: sub_menu_id, cart_type: type, denomination: denomination, cart_total: menu_price })
            .then((res) => {
                // console.log(res);
                            ...
                            <div className='col-lg-3  menu_sidebar ' >
                                <div className='menubar_col1_1'>
                                    <div className='menubar_div1 '>
                                        <a href="/"> <img src="http://hifivecafe.com/wp-content/uploads/2021/03/Hifive-Logo-1.png" width={"75px"} /></a>
                                    </div>
